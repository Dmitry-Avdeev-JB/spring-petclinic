...
class OwnerRestControllerTests {
    ...
    void testCreateOwnerWithId() throws Exception {
        ...
        mockMvc.perform(post("/api/owners")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{\"id\":1,\"firstName\":\"John\",\"lastName\":\"Doe\",\"address\":\"123 Main St\",\"city\":\"Anytown\",\"telephone\":\"1234567890\"}"))
            // then
    ...
    void testUpdateOwnerIdMismatch() throws Exception {
        ...
        mockMvc.perform(put("/api/owners/1")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{\"id\":2,\"firstName\":\"George Updated\",\"lastName\":\"Franklin\",\"address\":\"110 W. Liberty St.\",\"city\":\"Madison\",\"telephone\":\"6085551023\"}"))
            // then
            .andExpect(status().isBadRequest());
